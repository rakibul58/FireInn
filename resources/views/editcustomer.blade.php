    ...
    <form action="/updatecustomer/{{ $customers->id }}" method="POST">
      @csrf
        <div class="form-group">
          ...
          <input type="text" value="{{ $customers->name }}" class="form-control" placeholder="Enter Name" name="name">
        </div>
        <div class="form-group">
            <label for="email" class="form-label">Email</label>
            <input type="email" value="{{ $customers->email }}" class="form-control" placeholder="Enter Email" name="email">
        </div>
        <div class="form-group">
            <label for="password" class="form-label">Password</label>
            <input type="password" value="{{ $customers->password }}" class="form-control" placeholder="Enter Password" name="password">
        </div>
